Feature: Create reimbursement contract request
  ...
  Scenario: Successful creation
    ...
    And the following divisions exist:
      ...
      | "47e56ff3-75ae-416b-8d35-4b4a8409e3c0" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" |
      | "0ffa3a6e-12d8-40d8-8c60-ee7bcd7ef32f" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" |
    And the following employees exist:
      | databaseId                             | employeeType | legalEntityId                          |

Feature: Create reimbursement contract request
  ...
  Scenario: Successful creation
    ...
    And the following legal entities exist:
      ...
      | "e8d4b752-79e7-4906-835f-42397ac78b56" | "PHARMACY" | "ACTIVE" | true        |
  ...
  Scenario: Create with incorrect contractor legal entity status
    ...
    And the following legal entities exist:
      | databaseId                             | type       | status   | nhsVerified |
      | "e8d4b752-79e7-4906-835f-42397ac78b56" | "PHARMACY" | "CLOSED" | true        |
    And the following divisions exist:
      | databaseId                             | type        | legalEntityId                          | dlsVerified |
      | "47e56ff3-75ae-416b-8d35-4b4a8409e3c0" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" | true        |
      | "0ffa3a6e-12d8-40d8-8c60-ee7bcd7ef32f" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" | true        |
  ...
  Scenario: Create with contractor legal entity not passed NHS verification
    ...
    And the following legal entities exist:
      | databaseId                             | type       | status   | nhsVerified |
      | "e8d4b752-79e7-4906-835f-42397ac78b56" | "PHARMACY" | "ACTIVE" | false       |
    And the following divisions exist:
      | databaseId                             | type        | legalEntityId                          | dlsVerified |
      | "47e56ff3-75ae-416b-8d35-4b4a8409e3c0" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" | true        |
      | "0ffa3a6e-12d8-40d8-8c60-ee7bcd7ef32f" | "DRUGSTORE" | "e8d4b752-79e7-4906-835f-42397ac78b56" | true        |

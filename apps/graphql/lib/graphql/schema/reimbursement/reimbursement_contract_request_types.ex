defmodule GraphQL.Schema.ReimbursementContractRequestTypes do
  @moduledoc false
  ...
  alias GraphQL.Resolvers.ContractRequest, as: ContractRequestResolver
  alias GraphQL.Resolvers.ReimbursementContractRequest, as: ReimbursementContractRequestResolver
  ...
  node object(:reimbursement_contract_request) do
    ...
    field(:to_approve_content, :json, resolve: &ReimbursementContractRequestResolver.get_to_approve_content/3)
    field(:to_decline_content, :json, resolve: &ReimbursementContractRequestResolver.get_to_decline_content/3)

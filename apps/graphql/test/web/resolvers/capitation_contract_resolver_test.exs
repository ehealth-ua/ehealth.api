defmodule GraphQL.CapitationContractResolverTest do
  @moduledoc false
  ...
  describe "get by id" do
    ...
    test "success with attached documents", %{conn: conn} do
      ...
      expect(MediaStorageMock, :create_signed_url, 3, fn _, _, id, resource_name ->
    ...
    test "Media Storage invalid response for attachedDocuments", %{conn: conn} do
      ...
      expect(MediaStorageMock, :create_signed_url, fn _, _, _resource_name, _id ->

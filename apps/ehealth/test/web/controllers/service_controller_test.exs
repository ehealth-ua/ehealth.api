defmodule EHealth.Web.ServiceControllerTest do
  ...
  describe "get services" do
    test "success get services", %{conn: conn} do
      ...
      group3 = insert(:prm, :service_group, parent_group_id: group1.id, code: "G3")
      group4 = insert(:prm, :service_group, parent_group_id: group2.id, code: "G4")
      group5 = insert(:prm, :service_group, parent_group_id: group3.id, code: "G5")
      group6 = insert(:prm, :service_group, parent_group_id: group2.id, code: "G6")

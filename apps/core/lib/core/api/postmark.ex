defmodule Core.API.Postmark do
  @moduledoc false

  @behaviour Core.API.PostmarkBehaviour

  defp get_base_url, do: Confex.fetch_env!(:core, Core.API.Postmark)[:endpoint]

  defp get_request_headers do
    [
      Accept: "application/json",
      "Content-Type": "application/json",
      "X-Postmark-Server-Token": Confex.fetch_env!(:core, Core.Bamboo.PostmarkMailer)[:api_key]
    ]
  end

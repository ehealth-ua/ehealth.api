...
CREATE TABLE IF NOT EXISTS `mydb`.`division` (
  ...
  `phones[]` JSON NULL,
  `email` JSON NULL,
  INDEX `fk_division_msp1_idx` (`msp_id` ASC),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`employee` (
  ...
  `position` TEXT NOT NULL COMMENT 'посада',
...
-- -----------------------------------------------------
-- Table `mydb`.`legal_entity_requests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`legal_entity_requests` (
  `id` INT NOT NULL,
